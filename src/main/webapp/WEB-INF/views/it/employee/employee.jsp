...
<div class="container">
	<header class="page-header"><!-- We can add navigation bar here--><h1>IT Regular Employee</h1>	</header>
	<!-- End of header -->
    				...
    				<div class="sidebar-nav-fixed">
		        		<div class="well">         
				            <ul class="nav nav-list">				
								<li><a  class= "active" style="cursor: pointer;"  onclick="changeContent(1, '/sundevilbank/it/employee/op1')"> View Pending Requests</a></li>
								<li><a style="cursor: pointer;" onclick="changeContent(1, '/sundevilbank/it/employee/op2')"> Delete Customer </a></li>
