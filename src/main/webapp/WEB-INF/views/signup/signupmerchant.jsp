...
<form:form method="POST" commandName="signupusermerchant"  action="${pageContext.request.contextPath}/sales/salesemployee/signupusermerchant/SignupEmployeePost.html" >
